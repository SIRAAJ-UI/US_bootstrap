...
export class AppCommons {
    ...
    getMultiselectionDropDownSettings(isSingleSelection: any, idField: any, data: any, text: any, selectAllText: any, unselectAllText: any, limit: any = 1, isSearchFilter: any = false) {
        return {
    ...
    getObjectToArray(object: any, key: any) {
        let optionList: any = [];
        if (object.length) {
            object.map((item: any) => {
    ...
    getObjectToString(object: any, key: any) {
        let optionList: any = [];
    ...
    validateFeatureDate(dateKey: any) {
