...
export class LoginUserService {
  ...
  getUserInfo(): Observable<any> {
    return of({
        "screens": "10,20,21,22,23,24,26,30,40,41,42,43,44,301,311,316,321,331,341,351,361,3010,3011,3012,3013,3014,3015,3016,3017,3110,3111,3112,3113,3210,3211,3310",
        "userId": "cpakalapati",
        "userName": "Chikky",
    ...
    // devlopment purpose hide the below 
