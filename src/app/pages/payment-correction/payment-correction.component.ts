...
export class PaymentCorrectionComponent implements OnInit {
  ...
  public batchAgencyList: any = [];                        // hold batch ageny array of Object
  public newBatchAgencyName: any;
  public batchAgencyName: any;
  public batchAgencyNameTemp: any;

  public search = new PaymentCorrectionSearch();        // create search object for search form 
  public paymentCorrectionResponse: any;
  ...
  public paymentDetailModal: any = new PaymentDetailModal();   // hold payment detail form ng model keys
  public isBatchAgencyReadOnly: any = true;// hold batch agency read property
  public isSaveButtonDisable: any = true;
  public selReason: any; // hold payment reson ngmodel key
  public isEditable: any;
  taxdetail: any = {};
  public batchAgencyUpdateMeg: any; // update batch agnecy msg form backend side
  paymentId: any; // To store payment ID to hide multiple payment correction records
  ...
  selectedIndex: any;
  public isOnChnagePaymentCorrection: any;
  public paymentCorrectionSelectedObject: any = {};
  public paymentCorrectionSelectedObjectIndex: any;
  public selectedCorrectionOption: any;
  constructor(
    ...
    const loginData: any = this._globalService.getData();
  ...
  public calculateTotal(taxAmount: any, penaltyAmount: any, interestAmount: any, costAmount: any) {
  ...
  OnChangeReason(event: any, index: any) {
    ...
    var isReasonSelected = this.paymentCorrectionResponse.paymentCorrectionDetails
      .find((x: any) => x.selCorrectionReason != "Select Correction");
    if (isReasonSelected)
      this.isSaveButtonDisable = false;
   ...
   */
  public getPaymentCorrectionSearchResult(formValues: any) {
    this.isPaymentCorrectionFlag = false;
  ...
  * @description get payment correction search result based on form key
  */
  public getPaymentCorrectionSearchResultInit(formValues: any) {
   ...
   */
  private LoadPaymentCorrectionDetailsInit(responseData: any) {
   ...
   * @description get Payment correction search Response and store in paymentCorrecionResponse
   */
  private LoadPaymentCorrectionDetails(responseData: any) {
    //console.log("inside loadpaymentdetails"+responseData)
    if (responseData['item2'] == 'success') {
      this.paymentCorrectionResponse = responseData.item1;
      // Added Route
      if (this.paymentId && this.routerParams) {
        this.paymentCorrectionResponse['paymentCorrectionDetails'] = this.paymentCorrectionResponse.paymentCorrectionDetails.filter((item: any) => {
  ...
  public savePaymentDetail(ngModelObject: any) {
  ...
  public savePaymentCorrectionDetails(ngModelObject: any) {
