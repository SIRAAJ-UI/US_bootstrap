...
import { DailyBatchReportComponent } from './daily-batch-report.component';
...
export const routes:Routes = [
  { path: '', component: DailyBatchReportComponent, pathMatch: 'full' }
];
...
@NgModule({
  ...
  declarations: [
    DailyBatchReportComponent
]
})

export class DailyBatchReportModule { }
