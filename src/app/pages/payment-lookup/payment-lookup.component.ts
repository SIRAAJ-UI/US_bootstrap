...
export class PaymentLookupComponent implements OnInit, AfterViewInit {
  ...
  public apnKey: any;
  public updatedByKey: any;
  public paymentfiscalyearKey: any;
  public batchNoKey: any;
  public checkhNoKey: any;
  public tellerNoKey: any;
  public tracerNoKey: any;
  public ncrNoSearchKey: any;
  public taxBillYearSearchKey: any;
  public searchInstallmentSearchKey: any;
  public paymentStatusSearchKey: any;
  public paymentReasonSearchKey: any;
  public paymentSourceSearchKey: any;
  public paymentTaxTypeSearchKey: any;
  public totalAmountKey: any;
  public selectedSignKey: any;
  public paymentMethodSearchKey: any;
  public paymentTotalSearchKey: any;
  public batchAgencySearchKey: any;
  public supplementalTypeSearchKey: any;
  public methodTypeSearchKey: any;
  ...
  public transactionlNGModal:any = {
    Payment_From: "",
    Payment_To: "",
    fiscal_Year_From: "",
    fiscal_Year_To: "",
  ...
  public paymentFiscalNGModal:any = {
    fiscal_Year: [],
    payment_Status: [],
    payment_Source: [],
    t_type: []
  }
  public TaxFiscalNGModal:any = {
    fiscal_Year: [],
    payment_Status: [],
    payment_Source: [],
    t_type: []
  }
  public spinnerLoading: any = false;     // Loader icon property
  public entries: any = [];               // radio button selection property
  ...
  public totalLength: any = 0;                         // total length for Json Object 
  selectedEntry: { [key: string]: any } = {
    value: null,
    description: null
  };
  depositPaymentToDate: any;
  @ViewChild(PaginationComponent) pagerData: any;
  installmentList: any = [];
  selectResultConditon: any = [];
  ...
  filterTableHeaderData: any = [];
  dropdownSettings: any = {};
  dropdownSingleSelectSettings: any = {};
  selectedHeaderItem: any = "";
  batchAgencyList: any = [];
  ...
  setCost: (any: any) => void;
  setInterest: (any: any) => void;
  setTaxAmt: (any: any) => void;
  setPenalty: (any: any) => void;
  setFilterdItems: (any: any) => void;
  ...
  */
  constructor(
    ...
    this.setFilterdItems = items => {
      ...
      if (this.filteredItems) {
        this.costAmt = items.reduce(function (prev: any, cur: any) {
          return prev + cur.costAmount;
        }, 0);
        this.interestAmt = items.reduce(function (prev: any, cur: any) {
          return prev + cur.interestAmount;
        }, 0);
        this.taxAmtPaid = items.reduce(function (prev: any, cur: any) {
          return prev + cur.taxAmountPaid;
        }, 0);
        this.penaltyAmt = items.reduce(function (prev: any, cur: any) {
  ...
  isFieldValid(field: string): any {
   ...
   getPaymentSearcHistoryResponse(trxn_id: any,paymentId: any) {
  ...
  private apnFocus(value: any, object: any) {
    object['value'] = value;
    if (value) {
  ...
  private tracerFocus(value: any, object: any) {
    object['value'] = value;
    if (value) {
      object['hasValue'] = true;
      this.isAPNValid = false;
  ...
  apnFormValidation(event: any, object: any, key: any) {
    switch (key) {
      case 'apn':
...
*/
  ...
  resetForm(focus: any,searchTableHeader: any) {
    this.totalLength = 0;
  ...
  private getTableColumnList(headerColumnObject: any) {
...
this.downloadService.getBlobCSVData(csvData);
  ...
  * @memberof PaymentLookupComponent
  */
  public getPaymentLookupData(data: any) {
...
* @memberof PaymentLookupComponent
*/
  public returnDateISObject(dateObject: any) {
 ...
 */
  ...
  */
  ...
  getPaymentLookupSearchResult(searchType: any) {
    this.p=1;
    this.reverse = false;
  ...
  * @memberof PaymentLookupComponent
  */
  public getAPNPaymentLookupResponse(data: any) {
...
* @memberof PaymentLookupComponent
*/
  private getSelectedItemInArrayFormat(ngModelObject: any) {
    var splitedNgModel: any = [];
 ...
 * @param key
 */
  resetSearchOption(key: any, searchTableHeader: any) {
    //this.isFilterLimit=false;
  ...
  public resetSeachCriteriaNgModel() {
   ...
   public toggleRow(index: any, billId: any,paymentId: any, type: any) {
    if (type == 'expand') {
  ...
  *  
  *   */
  public onSelectionChange(entry:any, searchTableHeader:any) {
  ...
  public onTransactionDateSelectNotify(date: any, datePikcerType: any) {
  ...
  public routeToPaymentCorrection(object: any) {
  ...
  public onCreditDateSelectNotify(date: any, datePikcerType: any) {
    switch (datePikcerType) {
      case 'Payment_From':
  ...
  ngAfterViewInit() {
    const spinner_loader = document.getElementById('spinner_loader') as HTMLElement;
    spinner_loader.classList.add('hide');
    this.verticalHorizontalScrollConfig();
  }
 ...
 */
  ...
  * @memberof PaymentLookupComponent
  */
  filterByDate(inputValue: any, selectedHeaderItemKey: any) {
  ...
  */
  ...
  public getFilterDateJsonObject(inputValue: any, key: any) {
  ...
  * @memberof PaymentLookupComponent
  */
  filterTotalAmountData(inputValueKey: any, key: any, type: any, selectedType: any) {
  ...
  getReturnAllFilterData(inputValueKey: any, key: any, type: any, selectedType: any) {
