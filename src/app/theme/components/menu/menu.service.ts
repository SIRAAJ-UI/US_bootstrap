...
export class MenuService {
  ...
  public createMenu(menu:Array<Menu>, nativeElement: any, type: any){    
     if(type=='vertical'){
  ...
  public createHorizontalMenuItem(menu:Array<Menu>, menuItem: any){
      ...
      if(menuItem.hasSubMenu){
        ...
        this.renderer2.setAttribute(subMenu, 'id', 'link'+menuItem.id);        
  ...
  private createSubMenu(menu:Array<Menu>, menuItemId: any, parentElement: any, type: any){
  ...
  public addNewMenuItem(menu:Array<Menu>, newMenuItem: any, type: any){
